...
export STACK_NAME=PaperBuddyDev
...
export CHAT_TABLE_NAME="$(output_value ChatTableName)"
export LIBRARY_TABLE_NAME="$(output_value LibraryTableName)"
export FRONTEND_BUCKET_NAME="$(output_value FrontendBucketName)"
export RAG_SOURCE_BUCKET_NAME="$(output_value RagSourceBucketName)"
export USER_POOL_ID="$(output_value UserPoolId)"
...
export CDK_ASSET_REPOSITORY_NAME="$(
  aws cloudformation describe-stacks \
    --stack-name CDKToolkit \
    --region "$AWS_REGION" \
