...
- チャット生成AWSモード必須: `BEDROCK_KNOWLEDGE_BASE_ID`、`BEDROCK_GENERATION_MODEL_IDENTIFIER`
...
BEDROCK_GENERATION_MODEL_IDENTIFIER=apac.anthropic.claude-3-5-sonnet-20241022-v2:0
```
